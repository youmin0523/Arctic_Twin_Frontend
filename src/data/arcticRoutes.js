...
export const ROUTES = {
  ...
  // ─── 남극 로스해 항로 (ROSS) ──────────────────────────────────────────
  // 리틀턴(뉴질랜드) → 남빙양 남하 → 로스해 → 장보고기지(테라노바만, 빅토리아랜드)
  // 총 거리: 약 3,900km / 소요: 12일 (기준 항속 15노트, 정착빙·해빙역 감속 포함)
  // 한국 극지연구소 아라온의 실제 장보고기지 보급로. 케이프 아데어 동측으로 진입해
  // 로스해 개빙수역을 남하, 서안 빅토리아랜드 테라노바만으로 서진 접근. 전 구간 개방
  // 수역(여름)·계절 해빙역으로, 좁은 통항해협 없음(0.05° 마스크 검증 대상).
  ROSS: [
    { lon: 172.72, lat: -43.60, label: '리틀턴항' },
    { lon: 173.40, lat: -44.10, label: '뱅크스 반도 동방 외해' },
    { lon: 174.80, lat: -46.50, label: '뉴질랜드 남동 외해' },
    { lon: 176.50, lat: -50.00, label: '남태평양 남하' },
    { lon: 177.50, lat: -54.00, label: '남극순환류(ACC) 진입' },
    { lon: 177.00, lat: -58.00, label: '남빙양 (해빙 북한계)' },
    { lon: 175.00, lat: -62.00, label: '로스해 외곽 접근' },
    { lon: 173.00, lat: -66.00, label: '로스해 진입 (케이프 아데어 동방)' },
    { lon: 173.00, lat: -70.00, label: '로스해 중앙부' },
    { lon: 172.00, lat: -72.00, label: '로스해 서부 (콜먼섬 동방 외해)' },
    { lon: 171.00, lat: -73.00, label: '콜먼섬 동방 통과' },
    { lon: 170.00, lat: -73.70, label: '콜먼섬 남방 외해' },
    { lon: 169.50, lat: -74.00, label: '콜먼섬 완전 통과' },
    { lon: 167.50, lat: -74.05, label: '테라노바 동방 외해' },
    { lon: 166.50, lat: -74.00, label: '테라노바만 동방 외해' },
    { lon: 165.20, lat: -74.40, label: '테라노바만 입구' },
    { lon: 164.23, lat: -74.62, label: '장보고기지 (목적지)' },
  ],

  // ─── 남극반도 항로 (PENINSULA) ────────────────────────────────────────
  // 푼타아레나스(칠레) → 마젤란 해협 동진 → 드레이크 해협/스코샤해 남하 →
  //   사우스셰틀랜드 제도 → 세종기지(킹조지섬)
  // 총 거리: 약 2,100km / 소요: 8일 (기준 항속 15노트)
  // 마젤란 해협 동부 좁은 수로는 navigableCorridors.json 으로 면제. 이후 대서양측
  // 출구 → 드레이크 해협 개방수역 남하 → 남극수렴선 통과 → 킹조지섬.
  PENINSULA: [
    { lon: -70.92, lat: -53.16, label: '푼타아레나스항' },
    { lon: -70.20, lat: -52.95, label: '마젤란 해협 중앙' },
    { lon: -69.30, lat: -52.70, label: '마젤란 해협 동부' },
    { lon: -68.30, lat: -52.50, label: '마젤란 해협 대서양측 출구' },
    { lon: -65.00, lat: -53.20, label: '티에라델푸에고 동방 외해' },
    { lon: -63.50, lat: -55.00, label: '에스타도스 섬 동방 외해' },
    { lon: -62.50, lat: -58.00, label: '드레이크 해협 (스코샤해)' },
    { lon: -61.00, lat: -60.50, label: '남극수렴선 통과' },
    { lon: -59.50, lat: -61.80, label: '사우스셰틀랜드 북방 접근' },
    { lon: -59.20, lat: -62.00, label: '킹조지섬 외해' },
    { lon: -58.78, lat: -62.22, label: '세종기지 (목적지)' },
  ],
};
...
export const ROUTE_CORRIDOR = {
  ...
  // 남극 항로는 관문항↔기지 고정 경로(스플라이스 비대상)이나, 폴백 안전을 위해
  // 전 구간을 회랑으로 노출한다(routeGenerator 의 Antarctic 분기에서 직접 사용).
  ROSS:      { startIdx: 1,  endIdx: 15 }, // 뱅크스 동방 외해 → 테라노바만 입구
  PENINSULA: { startIdx: 1,  endIdx: 9 },  // 마젤란 중앙 → 킹조지섬 외해
};
